...
- (void)tap:(UITapGestureRecognizer *)tap {
    [self resetTouchImageWithPoint:[tap locationInView:self]];
...
-(void)updateValueWithValue:(CGFloat)value
{
    ...
    // 设置 Delegate
    if ([self.delegate respondsToSelector:@selector(cxSlider:ValueChanged:)])
    {
        [self.delegate cxSlider:self ValueChanged:value];
    }
}
